...
class BaseAggregator(AbstractStack):
    """
        The BaseAggregator class is an abstracted template for different types of data aggregators methods.

        There are 3 different aggregators types supported by the base aggregator, timeseries, tickseries, stat.
